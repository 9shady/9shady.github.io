    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'    => array(
            array(
                ...
                'subtitle'  => __('Display first when open page', TEXT_DOMAIN),
            ...
            array(
                'id'        => 'ova_animate',
                'type'      => 'select',                        
                'title'     => __('Display Animate for element', TEXT_DOMAIN),
                'subtitle'  => __('You can override this option in page attribute', TEXT_DOMAIN),
                'options'   => array(
                        'ova_animate'=>'Yes',
                        'no_ova_animate'=>'No'
                ),
...
<strong>Buyer Information: </strong><br/>[userinfo]
            ...
            Redux::setSection( $opt_name, array(
                'icon'      => 'el-icon-time',
                'title'     => __('Google API Settings', TEXT_DOMAIN),
                'fields'    => array(
                    array(
                        'id'        => 'google_api',
                        'type'      => 'text',
                        'title'     => __('Insert Google API Key to display google map', TEXT_DOMAIN),
                        'desc'  => __('Make Google API Key: <a href="https://developers.google.com/maps/documentation/javascript/get-api-key">https://developers.google.com/maps/documentation/javascript/get-api-key</a>', TEXT_DOMAIN),                        
                        'default'   => ''
                    ),
