...
<div id="comments" class="comments">
    ...
    $comment_args = array(
        ...
        'fields' => apply_filters('comment_form_default_fields', array(
            ...
            'email' => '<div class="form-group"><input type="text" name="email" value="' . esc_attr($commenter['comment_author_email']) . '" ' . esc_attr($aria_req) . ' class="form-control" placeholder="'. __('Email',TEXT_DOMAIN) .'" /></div></div>',
        )),
        'comment_field' => '<div class="form-group"><textarea class="form-control" rows="7" name="comment" placeholder="'. __('Your Message',TEXT_DOMAIN) .' ..."></textarea></div>',
        'label_submit' => 'Submit',
