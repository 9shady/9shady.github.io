...
class CMB2 extends CMB2_Base {
	...
	public function is_options_page_mb() {
		return ( // 'show_on' values checked for back-compatibility.
			$this->is_old_school_options_page_mb() || in_array( 'options-page', $this->box_types() ) );
	}
	...
	public function is_old_school_options_page_mb() {
		return ( // 'show_on' values checked for back-compatibility.
			isset( $this->meta_box['show_on']['key'] ) && 'options-page' === $this->meta_box['show_on']['key'] || array_key_exists( 'options-page', $this->meta_box['show_on'] ) );
	}
	...
	public function current_object_type() {
		...
		if ( in_array( $pagenow, array( 'admin.php', 'admin-post.php' ), true ) && $this->doing_options_page() ) {
			$type = 'options-page';
		}
	...
	public function add_group_field( $parent_field_id, array $field, $position = 0 ) {
		...
		$this->_add_field_to_array( $field, $this->meta_box['fields'][ $parent_field_id ]['fields'], $position );
