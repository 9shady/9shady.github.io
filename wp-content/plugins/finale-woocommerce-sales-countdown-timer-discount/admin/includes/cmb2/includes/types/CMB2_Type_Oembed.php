...
class CMB2_Type_Oembed extends CMB2_Type_Text {
	...
	public function render( $args = array() ) {
		...
		$oembed = ! empty( $meta_value ) ? cmb2_ajax()->get_oembed( array(
		...
		return parent::render( array(
			...
			) ) . '<p class="cmb-spinner spinner"></p>' . '<div id="' . $this->_id( '-status' ) . '" class="cmb2-media-status ui-helper-clearfix embed_wrap">' . $oembed . '</div>';
	}
