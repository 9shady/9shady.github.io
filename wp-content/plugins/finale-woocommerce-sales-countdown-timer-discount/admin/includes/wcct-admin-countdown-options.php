...
class WCCT_Admin_CountDown_Post_Options {
	...
	public static function setup_fields() {
		...
		$get_tabs             = include 'cmb2-countdown-meta-config.php';
	...
	public static function quick_view_metabox_fields() {
		...
		$shortcode_box = array(
			array(
				...
				'fields'   => array(
					array(
						'content'     => apply_filters( 'wcct_get_qyuck_view', "" ),
						'id'          => '_wcct_qv_html',
						'type'        => 'wcct_html_content_field',
	...
	public static function wcct_ideas_inner() {
		...
		$ideas_arr = array(
			array( "name" => "Get 13 Less-Known Campaign Ideas That Convert Like Crazy", "link" => "https://xlplugins.com/high-converting-woocommerce-sales-promotional-campaigs/", "tag" => "Book" ),
			array( "name" => "WooCommerce Discounts & Deals: 9 Untapped Tactics for Your Store", "link" => "https://xlplugins.com/woocommerce-discounts-deals/", "tag" => "Article" ),
			array(
			...
			array( "name" => "How to Set up Exclusive Festive Campaigns in WooCommerce?", "link" => "https://xlplugins.com/set-exclusive-festive-campaigns-woocommerce/", "tag" => "Article" ),
			array(
			...
			array( "name" => "How To Set Up Enticing Deals Of The Day Campaign?", "link" => "https://xlplugins.com/set-up-deal-of-the-day/", "tag" => "Article" ),
			array(
			...
			array( "name" => "How to Launch New & Upcoming Products With a Bang?", "link" => "https://xlplugins.com/launch-new-upcoming-products-bang/", "tag" => "Article" ),
		);
