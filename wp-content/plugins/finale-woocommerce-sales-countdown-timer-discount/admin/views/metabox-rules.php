...
<div class="wcct-rules-builder woocommerce_options_panel">
    ...
    <div class="label">
        ...
        <br/>
        <p class="description"><?php _e( "<i class='dashicons dashicons-editor-help'></i> Need Help with setting up Rules? <a href='https://xlplugins.com/documentation/finale-woocommerce-sales-countdown-timer-scheduler-documentation/rules/?utm_source=finale-pro&amp;utm_campaign=doc&amp;utm_medium=text-click&amp;utm_term=rules' target='_blank'>Watch Video or Read Docs</a>", 'finale-woocommerce-sales-countdown-timer-discount' ); ?></p>
