...
if ( ! class_exists( 'WCCT_Core' ) ) :
	...
	class WCCT_Core {
		...
		public function define_plugin_properties() {
			/*			 * ****** DEFINING CONSTANTS ********* */
			define( 'WCCT_VERSION', '2.1.0' );
			define( 'WCCT_MIN_WC_VERSION', '2.6' );
		...
		public function load_dependecies_support() {
			/** Setting up WooCommerce Dependency Classes */
			require_once( 'woo-includes/woo-functions.php' );
		}

		public function do_dependecy_check() {
		...
		public function include_commons() {
			...
			require 'includes/wcct-common.php';
			require 'compatibilities/class-wcct-compatibilities.php';
			require 'includes/wcct-xl-support.php';
		}

		public function wcct_mobile_check() {
			require 'includes/wcct-mobile-detect.php';
		...
		public function wcct_init() {
			...
			if ( wcct_is_woocommerce_active() && class_exists( 'WooCommerce' ) ) {
				...
				require 'includes/wcct-triggers-data.php';

				if ( is_admin() && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) {
				} else {
					require 'includes/wcct-api.php';
					require 'includes/wcct-campaign-public.php';
					require 'includes/wcct-appearance.php';
					require 'includes/wcct-cart.php';
					require 'includes/wcct-discount.php';
					require 'includes/wcct-stock.php';
				}
				require 'includes/wcct-themes-helper.php';
...
require 'includes/wcct-logging.php';
