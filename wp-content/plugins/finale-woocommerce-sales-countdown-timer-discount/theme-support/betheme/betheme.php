...
//    remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_price', 10);
		...
		add_action( 'woocommerce_after_single_product_summary', array( $wcct_core, 'wcct_position_above_tab_area' ), 8.3 );
		add_action( 'woocommerce_after_single_product', array( $wcct_core, 'wcct_position_below_related_products' ), 12.3 );
	}
