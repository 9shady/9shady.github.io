...
function wcct_theme_helper_x_store() {
	...
	remove_action( 'woocommerce_single_product_summary', array( $wcct_appearance_instance, 'wcct_position_below_meta' ), 41.3 );
	...
	add_action( 'woocommerce_single_product_summary', array( $wcct_appearance_instance, 'wcct_position_below_meta' ), 8 );
