...
if ( ! function_exists( 'wcct_theme_helper_eva' ) ) {
	function wcct_theme_helper_eva() {
		...
		remove_action( 'woocommerce_single_product_summary', array( $wcct_core, 'wcct_position_below_meta' ), 41.3 );
		...
		add_action( 'woocommerce_single_product_summary_single_meta', array( $wcct_core, 'wcct_position_below_meta' ), 42.3 );

		add_action( 'woocommerce_after_single_product_summary_data_tabs', array( $wcct_core, 'wcct_position_above_tab_area' ), 8.3 );
		add_action( 'woocommerce_after_single_product_summary_related_products', array( $wcct_core, 'wcct_position_below_related_products' ), 22.3 );
	}
}
