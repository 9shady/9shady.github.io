    ...
    private function get_help_tab_html()
    {
        ...
        ?></td>
                    ...
                    <tr>
                        ...
                        <td>Any set of elements that use layout attributes and are not direct descendants of <code>[md-form]</code> or <code>[md-card]</code> (E.g. nested inside a <code>&lt;div></code> or another shortcode) need to be wrapped in <code>[md-grid][/md-grid]</code> for layout attributes to work. A single <code>[md-grid][/md-grid]</code> should be the only direct descendant of the <code>&lt;div></code> (or whatever the wrapper is, e.g. a shortcode), and the other elements should be direct descendants of the <code>[md-grid]</code>.</td>
                        <td></td>
                    </tr>
                    <tr>
